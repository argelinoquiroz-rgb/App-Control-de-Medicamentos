...
def page_registrar():
    ...
    explicaciones_estado = {
        "Agotado": "🟡 **Agotado:** No disponible temporalmente.",
        "Desabastecido": "🔴 **Desabastecido:** No disponible en inventario ni mercado.",
        "Descontinuado": "⚫ **Descontinuado:** Retirado del mercado."
    }
